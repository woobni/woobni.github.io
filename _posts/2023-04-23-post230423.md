---
title: (Cloud)(Kubernetes) Hyper-v k8s 클러스터 구축
...
> **본 글은 Hyper-v Provisioning 이후 진행함. ‘쿠버네티스 클러스터 구성을 위한 Hyper-v Provisioning’ 포스팅 참고**
>
...
## **Disable SEL**inux (Security-Enhanced Linux)
...
2. [https://docs.tigera.io/calico/latest/getting-started/kubernetes/quickstart](https://docs.tigera.io/calico/latest/getting-started/kubernetes/quickstart)
