---
title: (kube-prometheus-stack) Prometheus/Thanos 연동
...
> 본 글은 ‘[(kube-prometheus-stack) Prometheus 기반 모니터링 시스템 구축](https://woobni.github.io/posts/post240513/)’ 포스팅 이후 진행됨
>
...
- Thanos Compactor는 TSDB 블록을 컴팩트하고 관리하기 때문에 안정적인 네트워크 ID와 스토리지가 필요하므로 StatefulSet을 사용하여 데이터 무결성과 서비스 안정성을 보장
