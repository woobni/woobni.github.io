...
3. Hyper-V 켜기
    ...
    ![Untitled](/assets/img/2023-03-29-post230629/Untitled.png)
...
2. pc 이름 우클릭 → 가상스위치 관리자
    ...
    ![Untitled](/assets/img/2023-03-29-post230629/Untitled%201.png)
    
3. 새 가상 네트워크 스위치 → 외부 → 가상 스위치 만들기
    
    ![Untitled](/assets/img/2023-03-29-post230629/Untitled%202.png)
    
4. 가상 스위치 설정:  연결 형식 → 외부 네트워크 → 연결되어 있는 네트워크 선택 → `확인`
    
    ![Untitled](/assets/img/2023-03-29-post230629/Untitled%203.png)
    
5. [경고] 보류 중인 변경 내용은 네트워크 연결을 방해할 수 있습니다 → `예`
    - *주의: 네트워크가 한 번 끊기고 다시 연결됨. 새로 생성된 네트워크 디바이스에 DNS 설정을 다시 해줘야 함.*
    
    ![Untitled](/assets/img/2023-03-29-post230629/Untitled%204.png)
...
![Untitled](/assets/img/2023-03-29-post230629/Untitled%205.png)

- 가상 컴퓨터 이름 설정
    
    ![Untitled](/assets/img/2023-03-29-post230629/Untitled%206.png)
    
- 1세대는 legacy 모델 이므로 2세대 선택
    
    ![Untitled](/assets/img/2023-03-29-post230629/Untitled%207.png)
    
- 메모리 할당 (주의! : 동적메모리 체크 해제)
    
    ![Untitled](/assets/img/2023-03-29-post230629/Untitled%208.png)
...
- Default Switch를 선택
    ...
    - 본 글에서는 스터디를 위하여 편의상 모든 노드에 외부망을 연결함
        ...
        ![Untitled](/assets/img/2023-03-29-post230629/Untitled%209.png)
        
- 가상 하드 디스크 만들기
    
    ![Untitled](/assets/img/2023-03-29-post230629/Untitled%2010.png)
    
- OS ISO 파일을 마운트 하고 다음을 클릭하여 진행
    
    ![Untitled](/assets/img/2023-03-29-post230629/Untitled%2011.png)
    
- 마침
    
    ![Untitled](/assets/img/2023-03-29-post230629/Untitled%2012.png)
    
- k8s-worker-node도 위와 동일한 방법으로 생성
    
    ![Untitled](/assets/img/2023-03-29-post230629/Untitled%2013.png)
...
- 프로세서 개수 변경
    ...
    ![Untitled](/assets/img/2023-03-29-post230629/Untitled%2014.png)
    
- 외부 통신을 위해 public network 추가
    
    ![Untitled](/assets/img/2023-03-29-post230629/Untitled%2015.png)
    
    ![Untitled](/assets/img/2023-03-29-post230629/Untitled%2016.png)
    
- 검사점 유형 변경
    
    ![Untitled](/assets/img/2023-03-29-post230629/Untitled%2017.png)
    
- 보안 부팅 사용 안함
    
    ![Untitled](/assets/img/2023-03-29-post230629/Untitled%2018.png)
    
- **실행**
    
    ![Untitled](/assets/img/2023-03-29-post230629/Untitled%2019.png)
